...
[OpenClaw](https://github.com/openclaw/openclaw)（🦞）是把 pi 接到 WhatsApp / Telegram / Discord / iMessage 上的多通道网关 —— 它是个好项目，很多人正是通过它第一次认识 pi。但我自己用下来，卡在两点：

- **内部机制太复杂** —— 复杂到使用者会感到**「失控」**：出了问题，不知道去哪儿找原因；
- **聊天软件这个信道本身有局限** —— 没有 streaming，你不知道它在干什么、干到哪一步了。
